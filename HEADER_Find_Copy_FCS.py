...
class Find_and_Copy_FCS(object):
    ...
    """
    def __init__(self,source,target,file_list_name,include_all=False):
    ...
    def _load_file_list(self):
        ...
        file_list=[]
        file = open(self.case_list_path,'r')
        for name in file:
...
if __name__ == '__main__':
    source_dir = "/Volumes/FlowCyto/LISTMODE/LSR data/Leukemia-Lymphoma/14-17200-17299"
    target_dir = "/Users/davidng/Desktop/Examples"
    file_list_name = "/Users/davidng/Documents/PYTHON/Input_Output/cases_to_find.txt"
    t=Find_and_Copy_FCS(source_dir,target_dir,file_list_name)
    print t.cases_not_found